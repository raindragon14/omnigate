...
const ALL_PROVIDERS: ProviderCandidate[] = [
  { id: "alpha", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 80, enabled: true, paidFallback: false, apiKeyEnv: "KEY_A", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: true, rateLimit: {} },
  { id: "beta", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 90, enabled: true, paidFallback: false, apiKeyEnv: "KEY_B", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: true, rateLimit: {} },
  { id: "gamma", baseUrl: "", model: "", family: "mimo-v2.5", priority: 100, enabled: true, paidFallback: false, apiKeyEnv: "KEY_C", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: true, rateLimit: {} },
  { id: "delta", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 70, enabled: false, paidFallback: false, apiKeyEnv: "KEY_D", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: true, rateLimit: {} },
  { id: "epsilon", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 50, enabled: true, paidFallback: true, apiKeyEnv: "KEY_E", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: true, rateLimit: {} },
  { id: "zeta", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 60, enabled: true, paidFallback: false, apiKeyEnv: "KEY_F", context: 100000, supportsTools: false, supportsJson: true, supportsStreaming: true, rateLimit: {} },
  { id: "eta", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 55, enabled: true, paidFallback: false, apiKeyEnv: "KEY_G", context: 100000, supportsTools: true, supportsJson: false, supportsStreaming: true, rateLimit: {} },
  { id: "theta", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 45, enabled: true, paidFallback: false, apiKeyEnv: "KEY_H", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: false, rateLimit: {} },
  { id: "iota", baseUrl: "", model: "", family: "deepseek-v4-flash", priority: 35, enabled: true, paidFallback: false, apiKeyEnv: "KEY_I", context: 100000, supportsTools: true, supportsJson: true, supportsStreaming: true, rateLimit: {} },
];
...
describe("selectProviderCandidates", () => {
  ...
  test("allows paid fallback when alias has allow_paid", () => {
    const result = selectProviderCandidates(makeInput({
      request: { model: "omnigate/emergency-paid", messages: [], stream: false, mode: "balanced" },
    }));

    expect(result.some((provider) => provider.id === "epsilon")).toBe(true);
  });
